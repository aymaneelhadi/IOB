...
import {
  ...
  require_dist2,
  require_dist3
} from "./chunk-MI5HMKSG.js";

// node_modules/@demox-labs/aleo-wallet-adapter-leo/dist/index.js
...
var import_aleo_wallet_adapter_base = __toESM(require_dist4());
  ...
  constructor({ appName = "sample", isMobile = false, mobileWebviewUrl } = {}) {
    ...
    if (this._readyState !== import_aleo_wallet_adapter_base.WalletReadyState.Unsupported) {
      (0, import_aleo_wallet_adapter_base.scopePollingDetectionStrategy)(() => {
        if ((window == null ? void 0 : window.leoWallet) || (window == null ? void 0 : window.leo)) {
          this._readyState = import_aleo_wallet_adapter_base.WalletReadyState.Installed;
          this.emit("readyStateChange", this._readyState);
          if ((window == null ? void 0 : window.leoWallet) && (window == null ? void 0 : window.leoWallet.isAvailable)) {
            window == null ? void 0 : window.leoWallet.isAvailable();
          }
          return true;
        }
        return false;
      ...
      switch (this._decryptPermission) {
        ...
        case import_aleo_wallet_adapter_base.DecryptPermission.OnChainHistory: {
          try {
            ...
            throw new import_aleo_wallet_adapter_base.WalletDecryptionError(error == null ? void 0 : error.message, error);
          }
        }
        default:
  ...
  async requestRecords(program) {
    try {
      ...
      try {
        ...
        throw new import_aleo_wallet_adapter_base.WalletRecordsError(error == null ? void 0 : error.message, error);
      }
    } catch (error) {
      this.emit("error", error);
      throw error;
  ...
  async requestTransaction(transaction) {
    try {
      ...
      try {
        ...
        throw new import_aleo_wallet_adapter_base.WalletTransactionError(error == null ? void 0 : error.message, error);
      }
    } catch (error) {
      this.emit("error", error);
      throw error;
  ...
  async connect(decryptPermission, network, programs) {
    try {
      ...
      try {
        ...
        if (!(wallet == null ? void 0 : wallet.publicKey)) {
          throw new import_aleo_wallet_adapter_base.WalletConnectionError();
        }
        this._publicKey = wallet.publicKey;
      } catch (error) {
        throw new import_aleo_wallet_adapter_base.WalletConnectionError(error == null ? void 0 : error.message, error);
      }
      this._wallet = wallet;
  ...
  async disconnect() {
    ...
    if (wallet) {
      ...
      try {
        ...
        this.emit("error", new import_aleo_wallet_adapter_base.WalletDisconnectionError(error == null ? void 0 : error.message, error));
      }
    }
  ...
  async signMessage(message) {
    try {
      ...
      try {
        ...
        throw new import_aleo_wallet_adapter_base.WalletSignTransactionError(error == null ? void 0 : error.message, error);
      }
    } catch (error) {
      this.emit("error", error);
      throw error;
